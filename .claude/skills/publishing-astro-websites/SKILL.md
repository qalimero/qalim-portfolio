...
- [Content Collections](#content-collections) — Content Layer API, Custom Loaders
...
- [Versioned Documentation](#versioned-documentation) —  Multi-version
...
3. **Inline SVG** - Target SVG classes with CSS (risk: style collisions) - add accessibility criteria with possibility to hqve role='image' or role="presentation:
```css
