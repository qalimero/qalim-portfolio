...
export function initSplineScene(containerId: string): SplineSceneInstance | null {
...
function fitCameraToCard(card: THREE.Object3D, camera: THREE.PerspectiveCamera) {
    ...
    camera.position.set(sphere.center.x, sphere.center.y, sphere.center.z + finalDistance);
    camera.lookAt(sphere.center);
