 ...
 * ctaRevealScene.ts
 *
 * WebGL2 pixel-creation overlay for the maintenance CTA link.
 *
...
/**
 * Mount a pixel-creation overlay inside `targetEl` (the `.maintenance-link`).
 *
 * The overlay builds up the fill colour pixel-by-pixel in a square mask,
